...
export function Header() {
  ...
  return <header className="site-header">
    ...
    <div className="nav-wrap">
      ...
      <Link href="/" className="wordmark"><span>Rasel</span> Birds of eden<small>আরামে বোনা গল্প</small></Link>
